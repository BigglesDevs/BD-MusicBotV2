  ...
  .setRun(async (client, interaction) => {
    ...
    helpEmbed.addFields({
      ...
      value:
        ...
        "\n" +
        `[✨ Support Server](${client.config.supportServer}) | [Source](https://github.com/BigglesDevs/BD-MuscicBotV2) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
    });
    ...
    collector.on("collect", async (iter) => {
      ...
      helpEmbed.addFields({
        ...
        value:
          ...
          "\n" +
          `[✨ Support Server](${client.config.supportServer}) | [Issues](${client.config.Issues}) | [Source](https://github.com/BigglesDevs/Discord-MusicBot/tree/v5) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
      });
      await iter.update({
        embeds: [helpEmbed],
        components: [getButtons(pageNo)],
